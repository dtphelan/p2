...
# Choose a random URL from Paul's website, instead of loading each page. Nicer to Paul, and improves performance of the password generator.
$key = array_rand($urls);
$chosenUrl = $urls[$key];
...
# Working on implementing more custimization options for users
$hyphenated = 'no';
$spaces = '';
...
# Concatenate a symbol to $password
if($symbols == 'on') {
